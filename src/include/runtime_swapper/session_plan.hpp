...
[[nodiscard]] constexpr SessionPlan make_session_plan(bool from_skse_loader,
                                                      ...
                                                      bool content_catalog_removed,
                                                      bool creation_club_removed) noexcept {
  const bool start_watcher = from_skse_loader &&
                             (runtime_changed || content_catalog_removed ||
                              creation_club_removed);
  return {start_watcher, start_watcher && runtime_changed,
          start_watcher && content_catalog_removed,
          start_watcher && creation_club_removed};
}
