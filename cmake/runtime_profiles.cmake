function(runtime_profile_files PROFILE TARGET_VERSION OUTPUT_VARIABLE)
  ...
  elseif(PROFILE STREQUAL "boaw" OR PROFILE STREQUAL "boaw-clean")
    set(PROFILE_FILES
      ${BOBW_FILES}
    ...
    if(PROFILE STREQUAL "boaw-clean")
      if(NOT TARGET_VERSION STREQUAL "1.6.1170")
        message(FATAL_ERROR "BoAW-Clean is only supported for 1.6.1170")
      endif()
      list(APPEND PROFILE_FILES "Data/ccvsvsse004-beafarmer.esl")
    endif()
  else()
...
function(runtime_profile_name PROFILE OUTPUT_VARIABLE)
  ...
  elseif(PROFILE STREQUAL "boaw-clean")
    set(PROFILE_NAME "Best-of-All-Worlds + Quick Auto Clean")
  else()
    message(FATAL_ERROR "Unknown runtime profile: ${PROFILE}")
  endif()
